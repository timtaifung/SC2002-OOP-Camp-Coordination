    ...
    public static void campCommMenu(Camp currentCamp, Student currentStudent, ArrayList<Camp> campList, ArrayList<Enquiry> enquiryList, ArrayList<Suggestion> suggestionList, ArrayList<CampCommittee> campCommitteeList){
        ...
        switch (x)
        {
            ...
            case 3:
            {
                ...
                if (choice.equals("Y"))
                    CampManager.leaveCamp(currentCampCommittee, currentCamp);
            ...
            case 5:
            {
                ...
                switch (y) {
                    ...
                    case 2:
                    {
                        ...
                        SuggestionManager.newSuggestion(suggestionList, currentStudent, currentCampCommittee);
                        currentCampCommittee.setpoint();
                        break;
                    }
                    case 3:
                    {
                        ...
                        Suggestion suggestionChoice = currentCampCommittee.getSuggestionList().get(suggestionIndex);
                        SuggestionManager.editSuggestion(suggestionChoice, currentCampCommittee);
                        break;
                    }
                    case 4:
                    {
